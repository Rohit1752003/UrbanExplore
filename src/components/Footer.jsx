        ...
        <div className="grid grid-cols-12 text-gray-800">
          <div className="col-span-12 lg:col-span-8 space-y-2 text-dark">
            <div className="flex space-x-3">
              <img src={icon || "/placeholder.svg"} alt="" className="h-10 w-10" />
              <div className="w-fit">
                <p className="text-xs">© 2024 Urban Explore LLC All rights reserved.</p>
            ...
            <div className="text-[0.7em] md:text-xs w-full space-y-3">
              <p>
                This is the version of our website addressed to speakers of English in India. If you are a resident of
                another country or region, please select the appropriate version of Urban Explore for your country or
              ...
              <p>
                ...
                please be sure to check their site for a full disclosure of all applicable fees. Urban Explore is
                committed to providing authentic urban exploration experiences and connecting travelers with the best
                city destinations across India.
              </p>
            </div>
          </div>
