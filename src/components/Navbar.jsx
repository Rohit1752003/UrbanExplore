...
const Navbar = ({ sticky, border }) => {
  ...
  return (
    ...
    <nav
      className={`${(scrolled || border) && "border-b-2"} ${sticky && "sticky top-0"} relative z-50 transition duration-700 bg-white`}
    >
      ...
      >
        {/* Logo */}
        <Link to={"/"}>
          <img src={logo || "/placeholder.svg"} alt="Urban Explore" className="w-[180px] sm:w-[200px] md:w-[250px]" />
        </Link>
        {/*  */}
